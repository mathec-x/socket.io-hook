...
var useSocket = function (props) {
    var _a = react_1.default.useState(), socket = _a[0], setSocket = _a[1];
...
var SocketIoProvider = function (_a) {
    ...
    if (socket) {
        return react_1.default.createElement(context_1.IoContext.Provider, __assign({ value: socket }, props));
    }
    else {
